...
public class RelationalOperators {
    ...
    public static void main(String[] args) {
        ...
        boolean isEligibleForLoan = creditScore >= 720; // if credit score is greater or equal to 720

        boolean result5 = 100< 120; //true

        System.out.println("result5 = " + result5);

        boolean result6 = 200 < 800; // false

        System.out.println("result6 = " + result6);

        int score = 75;

        boolean hasFailed = score <= 75;
        ...
        boolean result12 = "Java" != "Break"; // (!= not true)
