...
public class MyOffers {
    ...
    public static void main(String[] args) {
      ...
      offer1.setInfo ("VA", "Amazon", "SDET", 110000, true, true,
              true, true);
        ...
        offer3.setInfo ("FL", "Apple Inc", "QA", 125000, true, false,
                true, true);

        Offer offer4 = new Offer ();
        offer4.setInfo ("TX", "CapitalOne", "SM", 115000, false, false,
                true, true);
      ...
      System.out.println("-------------------------------------------------------------------------------");
        ...
        fullTimeOffers.removeIf(p-> !p.isFullTime);// removes if the offers are not full time
