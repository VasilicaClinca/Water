...
public class ArraysUtility {
    ...
    //print each double of an double array in separate lines
    ...
    //print each char of an char array in separate lines
    ...
    //print each String of an String array in separate lines
    ...
    public static int [] uniqueElements(int [] array) {
        ...
        for (int each : array){
            ...
            if(ArraysUtility.frequecyOfElement(array, each) == 1){ // if the frequency is one, the element is unique
    ...
    //merge the given 2 arrays and returns a new array
    ...
    //replace the elements of the array at given index with a new element
    ...
    public static boolean isStrongPassword (String password){
        ...
        boolean r5 = false;// has digitchar
